  ...
  return (
    <div className="home__data">
      <h1 className="home__tittle">
        ...
        {"  "}
        <svg width="30" xmlns="http://www.w3.org/2000/svg" viewBox="-40 -40 80 80">
          <circle r="39" />
          <path
            fill="#fff"
      ...
      <h3 className="home__subtittle">Desarrollador Web</h3>
      <p className="home__description">
        Soy de la ciudad de Medellin, y soy un apasionado de la tecnologia y la
        musica. Graduado de Digital House (Arg), con mucha motivación y
        expectativas para aprender y abrirme un camino en el ámbito laboral de
        la tecnología, cuento con mas de un año de practica en creación de
        paginas web sencillas (Html, Css, Sass, Javascript), con fines propios.
      </p>
