          ...
          <div className="contact__info">
            {/* <div className="contact__card">
              ...
              <span className="contact__card-data">
                juanjose.marinlujan@gmail.com
              </span>
              <a
                href="mailto:juanjose.marinlujan@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+57 304 620 64 03</span>
              <a
                href="https://api.whatsapp.com/send/?phone=573046206403&text&type=phone_number&app_absent=0"
                className="contact__button"
              >
                Escribeme{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">juanjosem.97</span>
